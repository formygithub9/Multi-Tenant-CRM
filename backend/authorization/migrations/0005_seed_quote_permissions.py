...
def seed_quote_permissions(apps, schema_editor):
...
def reverse_quote_permissions(apps, schema_editor):
    Permission = apps.get_model("authorization", "Permission")
    Module = apps.get_model("authorization", "Module")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("authorization", "0004_seed_deal_permissions"),
    ]

    operations = [
        migrations.RunPython(
            seed_quote_permissions,
            reverse_quote_permissions,
        ),
    ]